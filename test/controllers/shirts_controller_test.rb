...
class ShirtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shirt" do
    assert_difference("Shirt.count") do
      post shirts_url, params: { shirt: { brand: @shirt.brand, color: @shirt.color, size: @shirt.size } }
    end
  ...
  test "should update shirt" do
    patch shirt_url(@shirt), params: { shirt: { brand: @shirt.brand, color: @shirt.color, size: @shirt.size } }
